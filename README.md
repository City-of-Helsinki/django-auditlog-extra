...
Each time you merge a "normal" pull request, the release-please-action will create or update a "Release PR" with the changelog and the version bump related to the changes (they're named like `release-please--branches--main--components--django-auditlog-extra-`).
...
This project uses Hatchling, a modern build system for Python projects.  It simplifies the build and packaging process, providing a consistent and efficient way to manage your project's dependencies and create distributable packages.  Hatchling supports various build backends, allowing you to customize the build process to your needs.  It also integrates seamlessly with PyPI, making publishing your package straightforward.  For more detailed information on Hatchling's features and usage, refer to the official documentation: [https://hatch.pypa.io/latest/](https://hatch.pypa.io/latest/)
